    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center w-full">
          ...
          <h1 
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 sm:mb-6 leading-tight text-black transition-all duration-700 delay-150 ${
              mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            Your AI Marketing
        ...
        {/* Subtitle */}
        <p 
          className={`text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto px-4 transition-all duration-700 delay-450 ${
            mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        <form 
          ...
          className={`w-full max-w-md mx-auto transition-all duration-700 delay-600 ${
            mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
        ...
        {/* Trust Indicators */}
        <div 
          className={`mt-6 sm:mt-8 flex items-center justify-center text-xs sm:text-sm text-gray-500 transition-all duration-700 delay-750 ${
